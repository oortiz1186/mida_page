...
export default function WhatsAppButton() {
  // Configura aquí tu número de WhatsApp real (Código de país + número sin espacios)
  const whatsappUrl = "https://wa.me/5214776624271?text=Hola%20MIDA,%20vi%20su%20p%C3%A1gina%20web%20y%20me%20interesa%20una%20asesor%C3%ADa%20tecnol%C3%B3gica.";
  ...
  return (
    ...
    >
      {/* Icono de WhatsApp en SVG limpio */}
      ...
      {/* Texto sutil "tooltip" al pasar el cursor */}
